...
function pestania2() {///Muestra/Esconde las opciones de casos de actor Colectivo
  ...
  function fichadeRecepcion(a){
		  if(a=="1"){
			...
			$('#fichaExactaR').attr('name', 'casos_fechaTermino');
			$("#fichaAproxVR").hide();
			$("#fichaSinDiaVR").hide();
			...
			$('#fichaAproxR').attr('name', 'casos_fechaTermino');
		  }
		  else if (a=="3"){
			$("#fichaAproxVR").hide();
			$("#fichaSinDiaSinMesVR").hide();
			...
			$('#fichaExactaR').attr('name', ' ');
			$('#fichaAproxR').attr('name', ' ');
			$('#fichaSinDiaR').attr('name', 'casos_fechaTermino');
		  }
		  else if (a=="4"){;
			$("#fichaAproxVR").hide();
			$("#fichaSinDiaVR").hide();
			...
			$('#fichaAproxR').attr('name', ' ');
			$('#fichaSinDiaR').attr('name', '');
			$('#fichaSinDiaSinMesR').attr('name', 'casos_fechaTermino');
		  }
  ...
  function fechaInicialCasosRP(a){
		  if(a=="1"){
			...
			$('#fechaExactaRP').attr('name', 'relacionActores_fechaInicial');
			$("#fechaAproxVRP").hide();
			$("#fechaSinDiaVRP").hide();
			...
			$('#fechaAproxRP').attr('name', 'relacionActores_fechaInicial');
		  }
		  else if (a=="3"){
			$("#fechaAproxVRP").hide();
			$("#fechaSinDiaSinMesVRP").hide();
			...
			$('#fechaExactaRP').attr('name', ' ');
			$('#fechaAproxRP').attr('name', ' ');
			$('#fechaSinDiaRP').attr('name', 'relacionActores_fechaInicial');
		  }
		  else if (a=="4"){;
			$("#fechaAproxVRP").hide();
			$("#fechaSinDiaVRP").hide();
			...
			$('#fechaAproxRP').attr('name', ' ');
			$('#fechaSinDiaRP').attr('name', '');
			$('#fechaSinDiaSinMesRP').attr('name', 'relacionActores_fechaInicial');
		  }
  ...
  function fechaTerminalCasosRP(a){
		  if(a=="1"){
			...
			$('#fechaExacta2RP').attr('name', 'relacionActores_fechaTermino');
			$("#fechaAproxV2RP").hide();
			...
			$('#fechaAprox2RP').attr('name', 'relacionActores_fechaTermino');
		  }
		  else if (a=="3"){
			$("#fechaAproxV2RP").hide();
			$("#fechaSinDiaSinMesV2RP").hide();
			...
			$('#fechaExacta2RP').attr('name', ' ');
			$('#fechaAprox2RP').attr('name', ' ');
			$('#fechaSinDia2RP').attr('name', 'relacionActores_fechaTermino');
		  }
		  else if (a=="4"){;
			$("#fechaAproxV2RP").hide();
			$("#fechaSinDiaV2RP").hide();
			...
			$('#fechaAprox2RP').attr('name', ' ');
			$('#fechaSinDia2RP').attr('name', '');
			$('#fechaSinDiaSinMes2RP').attr('name', 'relacionActores_fechaTermino');
		  }
